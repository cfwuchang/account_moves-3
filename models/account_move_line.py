...
class AccountMoveLine(models.Model):
    ...
    x_price_subtotal = fields.Float(string=u'含税小计',compute='_get_x_price_subtotal',readonly=False,)
    ...
    @api.depends('x_price','quantity')
    def _get_x_price_subtotal(self):
        for obj in self:
            obj.x_price_subtotal=obj.x_price*obj.quantity